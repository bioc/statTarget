...
###...........................................................................  
### This function provide the odd.ratio value for metabolomics data.
### file The file with the expression information. 
### An odds ratio is a measure of association between 
### an exposure and an outcome. OR is equal to 1, which means 
### exposure does not affect odds of outcome. OR  is high than 1,
### which means exposure associated with higher odds of outcome.
###  OR is less than 1, which means exposure associated with lower 
###  odds of outcome.The 95 percent of confidence interval (CI)
### is used to estimate the precision of the OR. A large CI 
### indicates a low level of precision of the OR, whereas a 
###   small CI indicates a higher precision of the OR. It is 
###  important to note however, that unlike the p value, 
###  the 95 percent of CI does not report a statistical significance. 
###...........................................................................  
    ...
    for (j in 1:NoF) {
      if (i < j) {
        ...
        logit_or <- function(outcome,a){
                    glm.log <- glm(outcome~scale(a),control = list(maxit = 50),
        ...
        or <- apply(t(IJM),1,function(x){logit_or(outFactor,x)})
        or <- as.data.frame(t(or))
        #write.table(or,"odds_radio.txt",sep="\t",quote=F)
        or.ij = paste("odds_radio_", ExcName(i,slink), "vs", 
