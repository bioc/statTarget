...
#Due to the RGtk2 have been removed from CRAN, RGtk2 should be installed manually from the old source, Link: https://cran.r-project.org/src/contrib/Archive/RGtk2/
