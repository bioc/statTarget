...
The main GUI of statTarget has two basic components. The first component 
...
The generalised cross-validation was used to avoid overfitting the observed data
...
The number of NA value in Data Profile after the initial imputation: 1

The number of NA value in Data Profile after the second imputation (KNN): 0
